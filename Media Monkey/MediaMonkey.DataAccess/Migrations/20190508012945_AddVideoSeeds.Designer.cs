...
namespace MediaMonkey.DataAccess.Migrations
{
    ...
    [Migration("20190508012945_AddVideoSeeds")]
    partial class AddVideoSeeds
    {
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountryId = 1, CreationDate = new DateTime(2019, 5, 1, 13, 14, 4, 0, DateTimeKind.Unspecified), Description = "Joe is the master.", Email = "jdoe@gmail.com", FirstName = "John", IsAdmin = true, IsArchived = false, IsEmailVerified = true, IsOwner = true, LastLogin = new DateTime(2019, 5, 7, 20, 29, 45, 329, DateTimeKind.Local), LastName = "Doe", Password = "AQAAAAEAACcQAAAAEKQ1ccM69zyRO+RbwtB3muSaviqjcj+kXa9Ee7Ou3BWhg7YxKkVr8PF8YttEv/ypeQ==", Username = "jDoe37" }
                    );
                });
