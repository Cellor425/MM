...
namespace MediaMonkey.DataAccess.Migrations
{
    ...
    [Migration("20190508210809_AddLikeSeedData")]
    partial class AddLikeSeedData
    {
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountryId = 1, CreationDate = new DateTime(2019, 5, 1, 13, 14, 4, 0, DateTimeKind.Unspecified), Description = "Joe is the master.", Email = "jdoe@gmail.com", FirstName = "John", IsAdmin = true, IsArchived = false, IsEmailVerified = true, IsOwner = true, LastLogin = new DateTime(2019, 5, 8, 16, 8, 9, 67, DateTimeKind.Local), LastName = "Doe", Password = "AQAAAAEAACcQAAAAEKQ1ccM69zyRO+RbwtB3muSaviqjcj+kXa9Ee7Ou3BWhg7YxKkVr8PF8YttEv/ypeQ==", Username = "jDoe37" }
                    );
                });
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.ProfileDislikedVideo", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ProfileId = 1, VideoId = 2 },
                        new { Id = 2, ProfileId = 1, VideoId = 3 }
                    );
                });
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.ProfileLikedVideo", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ProfileId = 1, VideoId = 1 },
                        new { Id = 2, ProfileId = 1, VideoId = 2 }
                    );
                });
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.Video", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 6, Format = "video/mp4", Path = "/videos/NTCpie1.MOV", Size = 0 },
                        new { Id = 7, Format = "video/mp4", Path = "/videos/NTCpie2.MOV", Size = 0 },
                        new { Id = 8, Format = "video/mp4", Path = "/videos/NTCpie3.MOV", Size = 0 },
                        new { Id = 9, Format = "video/mp4", Path = "/videos/NTCpie4.MOV", Size = 0 },
                        new { Id = 10, Format = "video/mp4", Path = "/videos/NTCpie5.MOV", Size = 0 }
                    );
                });
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.VideoInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ProfileId = 1, VideoId = 6, Description = "Pie to the Face", Id = 6, IsArchived = false, IsUploadFinished = true, Title = "NTCpie1", UploadDate = new DateTime(2019, 5, 1, 13, 23, 42, 0, DateTimeKind.Unspecified), Views = 0, VisibilityId = 1 },
                        new { ProfileId = 1, VideoId = 7, Description = "Pie to the Face", Id = 7, IsArchived = false, IsUploadFinished = true, Title = "NTCpie2", UploadDate = new DateTime(2019, 5, 1, 13, 23, 42, 0, DateTimeKind.Unspecified), Views = 0, VisibilityId = 1 },
                        new { ProfileId = 1, VideoId = 8, Description = "Pie to the Face", Id = 8, IsArchived = false, IsUploadFinished = true, Title = "NTCpie3", UploadDate = new DateTime(2019, 5, 1, 13, 23, 42, 0, DateTimeKind.Unspecified), Views = 0, VisibilityId = 1 },
                        new { ProfileId = 1, VideoId = 9, Description = "Pie to the Face", Id = 9, IsArchived = false, IsUploadFinished = true, Title = "NTCpie4", UploadDate = new DateTime(2019, 5, 1, 13, 23, 42, 0, DateTimeKind.Unspecified), Views = 0, VisibilityId = 1 },
                        new { ProfileId = 1, VideoId = 10, Description = "Pie to the Face", Id = 10, IsArchived = false, IsUploadFinished = true, Title = "NTCpie5", UploadDate = new DateTime(2019, 5, 1, 13, 23, 42, 0, DateTimeKind.Unspecified), Views = 0, VisibilityId = 1 }
                    );
                });
