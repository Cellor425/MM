...
namespace MediaMonkey.DataAccess.Migrations
{
    ...
    [Migration("20190509003822_RemovedTags")]
            ...
            modelBuilder.Entity("MediaMonkey.DataAccess.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountryId = 1, CreationDate = new DateTime(2019, 5, 1, 13, 14, 4, 0, DateTimeKind.Unspecified), Description = "Joe is the master.", Email = "jdoe@gmail.com", FirstName = "John", IsAdmin = true, IsArchived = false, IsEmailVerified = true, IsOwner = true, LastLogin = new DateTime(2019, 5, 8, 19, 38, 21, 939, DateTimeKind.Local), LastName = "Doe", Password = "AQAAAAEAACcQAAAAEKQ1ccM69zyRO+RbwtB3muSaviqjcj+kXa9Ee7Ou3BWhg7YxKkVr8PF8YttEv/ypeQ==", Username = "jDoe37" }
                    );
                });
